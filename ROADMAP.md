...
| Item | Shipped | Notes |
|---|---|---|
| You only learn what you played | 2026-07-26 | The post-round panel is gone: it printed the best score available, named who you should have taken, and counted the winning line-ups, which answered the two rounds still to come and squashed the field doing it. What a round tells you now is what your own picks scored, in the play-out. In later rounds those players carry their real number on the field and on the wire; everyone else stays a question mark, so standing pat versus gambling is a real decision. The "already decided" honesty line moved into the play-out rather than dying with the panel. |
